...
Steps.defaultProps = {
  step3Title: 'Document Verification',
  step2Description:
    'Upload all necessary documents such as academic records, identification proof, and bank details.',
  step3Description:
    'The SAG Bureau will verify the uploaded documents for authenticity and eligibility.',
  step4Title: 'Payment Disbursement',
  step2Title: 'Upload Required Documents',
  step1Title: 'Register on the Portal',
  step4Description:
    'Once the documents are approved, the Finance Bureau will process the scholarship payment.',
  step1Description:
    'Create an account on the PMSSS scholarship portal using your valid credentials.',
}
