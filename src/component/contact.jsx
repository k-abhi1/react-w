...
Contact.defaultProps = {
  ...
  content5:
    'Stay connected with us for updates and information related to the PMSSS.',
  email1: 'info@pmsss.gov.in',
  phone1: '+91-XXX-XXX-XXXX',
  content2:
    'Our team is here to help and provide support regarding the PMSSS scholarship scheme.',
  content4:
    'We strive to respond promptly to all inquiries and provide the necessary assistance.',
  content3:
    'For general inquiries or feedback, please contact us via email or phone.',
  heading1: 'Contact Us',
